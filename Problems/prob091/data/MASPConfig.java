...
public class MASPConfig {


    //resource domain (IDs) definitions
    public static final int[] CARDIOLOGY_DOMAIN = {0,1,2,3};
    public static final int[] NEUROLOGY_DOMAIN = { 4,5,6,7};
    public static final int[] CURRENT_WORKLOAD = {40, 35, 15, 10, 30, 25, 20, 5};
    public static final int SLOTS_PER_DAY = 24; // Number of time slots per day
    
    /* Resource calendars domain, each resource calendar is represented by an integer array of available slot identifiers */
 ...
 // Sequence of predefined appointments
    ...
    // Order of appointments in the sequence
    ...
    // Same resources across different appointments
    ...
    //j indicies of patient absence dates in the global calendar
