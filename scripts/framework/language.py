...
def process_language(prob, apply_template, output_dir, base):
	"Creates the language's html"
	...
	prob_dir_in = path.join(base, "Languages{0}".format(prob.name))
